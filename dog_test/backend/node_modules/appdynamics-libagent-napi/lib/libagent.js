...
LibAgent.prototype.init = function (agent) {
  ...
  if(opts.kbConfigEnabled) {
    agentInfo.kbClusterEnabled = true;
    agentInfo.kbHost = opts.kbHost;
    agentInfo.kbPort = opts.kbPort;
    agentInfo.kbPodName = opts.kbPodName;
    agentInfo.kbContainerName = opts.kbContainerName;
    agentInfo.kbNspace = opts.kbNspace;
  }
...
LibAgent.prototype.getBusinessTransactionQueryType = function (entryPointType, callback) {
  return this.agent.getBusinessTransactionQueryType(entryPointType, callback);
};

LibAgent.prototype.getContainerId = function () {
  return this.agent.getContainerId();
};
